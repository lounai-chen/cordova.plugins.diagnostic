...
var Diagnostic = (function(){
     ...
     */
    Diagnostic.requestIgnoreBatteryOptimizations = function() {
        if (cordova.plugins.diagnostic.notifications){
            cordova.plugins.diagnostic.notifications.requestIgnoreBatteryOptimizations.apply(this, arguments);
        } else {
            throw "Diagnostic notification module is not installed";
        }
    };
     ...
     */
    Diagnostic.switchToActiveInBackgroundSetting = function() {
        if (cordova.plugins.diagnostic.notifications){
            cordova.plugins.diagnostic.notifications.switchToActiveInBackgroundSetting.apply(this, arguments);
        } else {
            throw "Diagnostic notification module is not installed";
        }
    };
     ...
     * getDownloadChannels
     */
    Diagnostic.getDownloadChannels = function(successCallback, errorCallback, key) {
        if (cordova.plugins.diagnostic.notifications){
            cordova.plugins.diagnostic.notifications.getDownloadChannels.apply(this, arguments);
        } else {
            throw "Diagnostic notification module is not installed";
        }
    };
