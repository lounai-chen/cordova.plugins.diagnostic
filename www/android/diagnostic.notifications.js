...
var Diagnostic_Notifications = (function(){
     ...
     */
    Diagnostic_Notifications.requestIgnoreBatteryOptimizations = function() {
        return cordova.exec(null,
            null,
            'Diagnostic_Notifications',
            'requestIgnoreBatteryOptimizations',
     ...
     */
    Diagnostic_Notifications.switchToActiveInBackgroundSetting = function() {
        return cordova.exec(null,
            null,
            'Diagnostic_Notifications',
            'switchToActiveInBackgroundSetting',
     ...
     * getDownloadChannels
     */
    Diagnostic_Notifications.getDownloadChannels = function(successCallback, errorCallback, key) {
